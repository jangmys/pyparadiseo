...
template <>
numpy::ndarray getv< std::vector<double>, numpy::ndarray >
(const eoValueParam< std::vector<double> >& param)
{
...
template <>
void setv< std::vector<double>, numpy::ndarray >
(eoValueParam< std::vector<double> >& param, numpy::ndarray val)
{
...
void valueParam()
{
    ...
    define_valueParam<std::vector<double>, numpy::ndarray >("Vec");
