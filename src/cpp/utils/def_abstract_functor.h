...
#define WC3 boost::python::with_custodian_and_ward<1,2,\
    bp::with_custodian_and_ward<1,3,\
    bp::with_custodian_and_ward<1,4\
    > > >()
#define WC4 boost::python::with_custodian_and_ward<1,2,\
        bp::with_custodian_and_ward<1,3,\
        bp::with_custodian_and_ward<1,4,\
        bp::with_custodian_and_ward<1,5\
        > > > >()
#define WC5 boost::python::with_custodian_and_ward<1,2,\
        bp::with_custodian_and_ward<1,3,\
        bp::with_custodian_and_ward<1,4,\
        bp::with_custodian_and_ward<1,5,\
        bp::with_custodian_and_ward<1,6\
        > > > > >()
#define WC6 boost::python::with_custodian_and_ward<1,2,\
        bp::with_custodian_and_ward<1,3,\
        bp::with_custodian_and_ward<1,4,\
        bp::with_custodian_and_ward<1,5,\
        bp::with_custodian_and_ward<1,6,\
