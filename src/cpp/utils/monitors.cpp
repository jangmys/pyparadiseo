...
void monitors()
{
    ...
    // eoMonitor& (eoFileMonitor::*fx1)(void) = &eoFileMonitor::operator();
    // eoMonitor& (eoFileMonitor::*fx2)(std::ostream&) = &eoFileMonitor::operator();
    //
    // class_<eoFileMonitor,bases<eoMonitor>>("eoFileMonitor",init<std::string,std::string,optional<bool,bool,bool>>())
    // .def("__call__",fx1,return_internal_reference<1>())
    // .def("__call__",fx2,return_internal_reference<1>())
    // ;
}
