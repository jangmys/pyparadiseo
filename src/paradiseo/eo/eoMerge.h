...
public:
    ...
    void
    operator () (const eoPop<EOT>& _pop, eoPop<EOT>& _offspring)
    {
        ...
        //JG : this copies ALL _pop to _offspring ... nth_element puts all elts leq combienLocal before and all geq after...but size is == pop
        // for (size_t i = 0; i < result.size(); ++i) {
        //     _offspring.push_back(*result[i]);
        // }
        for (size_t i = 0; i < combienLocal; ++i) {
            _offspring.push_back(*result[i]);
        }
